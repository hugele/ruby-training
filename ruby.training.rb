...
# 1000 / ( 5 × 18 ) と 3000 / ( 12 × 21 )を比較すると1枚目のレジャーシートが面積あたりの価格が安いので以下のように出力します。
# 5 18 1000

input0 = gets.chomp.split(" ")
input1= gets.chomp.split(" ")

price0=input0.map &:to_f
price1=input1.map &:to_f

num1=price0[2]/(price0[0]*price0[1])
num2=price1[2]/(price1[0]*price1[1])
